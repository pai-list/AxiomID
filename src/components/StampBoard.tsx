  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Trust Gauge card */}
        <div className="bento-card p-6 flex items-center justify-between border border-border bg-surface-muted/10">
        ...
        {/* Progress Card */}
        <div className="bento-card p-6 flex flex-col justify-between border border-border bg-surface-muted/10 md:col-span-2 col-span-1">
          ...
          <div className="space-y-2 mt-4">
            <div className="h-2 w-full bg-surface-muted/30 rounded-full overflow-hidden border border-border">
              <div
      ...
      >
        <div className="bento-card max-w-lg w-full p-6 border border-border shadow-2xl bg-surface-deep">
          <div className="flex justify-between items-start mb-4">
            ...
            <button
              ...
              className="text-faint hover:text-surface text-xs font-mono border border-border hover:border-border px-3 py-2 min-h-[44px] min-w-[44px] flex items-center justify-center rounded cursor-pointer"
            >
              {t('close')}
            </button>
          </div>
          ...
          {activeVc && (
            <div className="space-y-4">
              <pre className="text-[9px] text-neon-green font-mono bg-surface-deep/80 p-3 rounded-lg border border-border overflow-x-auto max-h-64 scrollbar-thin">

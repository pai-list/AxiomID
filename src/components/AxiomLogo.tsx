...
export function AxiomLogo({ size = "md", showWordmark = true, className = "" }: AxiomLogoProps) {
  ...
  return (
    <div className={`flex items-center gap-2 group ${className}`} aria-label={showWordmark ? undefined : "AXIOMID"}>
      <div className={`${s.box} flex items-center justify-center border border-border bg-card relative group overflow-hidden transition-all duration-300 hover:border-electric-blue/40`}>
        ...
        <svg className={`${s.svg} z-10 text-surface filter drop-shadow-[0_0_8px_rgba(0,212,255,0.4)]`} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden={showWordmark ? "true" : undefined}>
          ...
          <path d="M50 24 L74 74 L62 74 L50 48 L38 74 L26 74 Z" fill="currentColor" />
          <path d="M40 64 H60 L58 68 H42 Z" fill="currentColor" className="text-neon-green" />
          <defs>

      ...
      <div className="flex justify-between items-start">
        ...
        <span className={`text-[9px] font-mono px-2 py-0.5 rounded-full ${
          isConnected
            ...
            : "bg-surface-muted/30 text-faint border border-border"
        }`}>
        ...
        {isConnected ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            <input
              ...
              className="w-full bg-surface-deep/40 border border-border rounded-lg px-2.5 py-1.5 text-xs text-surface placeholder:text-subtle focus:outline-none focus:border-neon-green/40 font-mono"
            />

    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
      ...
      <div className="bento-card p-4 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <span className="text-[9px] font-mono text-faint uppercase tracking-wider block truncate">{t("trust_score_label")}</span>
      ...
      <div className="bento-card p-4">
        <span className="text-[9px] font-mono text-faint uppercase tracking-wider block mb-1.5">{t("xp_progress")}</span>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-mono text-faint shrink-0">{xpNeeded} to go</span>
        </div>
      </div>
      ...
      <div className="bento-card p-4 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <span className="text-[9px] font-mono text-faint uppercase tracking-wider block truncate">{t("agent_status")}</span>
      ...
      {/* Days Active - Counter */}
      <div className="bento-card p-4">
        <span className="text-[9px] font-mono text-faint uppercase tracking-wider block mb-1">{t("days_active")}</span>

...
export default function HeroSection({ t }: HeroSectionProps) {
  return (
    <section className="w-full max-w-6xl px-4 sm:px-6 pt-28 sm:pt-36 pb-[clamp(3rem,8vh,5rem)] z-10">
      {/* Centered copy block — OpenAI / Apple / Vercel breathing room */}
      <div className="flex flex-col items-center text-center space-y-7 sm:space-y-8 animate-fade-in">
        {/* Monospace Pi badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] shadow-[0_0_20px_rgba(255,255,255,0.03)] backdrop-blur-sm">
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
          <span className="text-[10px] font-mono tracking-[0.18em] text-emerald-400/90 font-medium uppercase">
            {t("landing_pi_badge")}
          </span>
        </div>

...
export default function InteractiveShowcase() {
  ...
  return (
    <div className="w-full flex flex-col gap-8 mb-16">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-full text-xs font-mono transition-all duration-300 ${
              activeTab === tab.id
                ...
                : 'bg-glass text-faint border border-glass-hover hover:bg-glass-hover hover:text-white'
            }`}
          >
            {tab.icon}
            {tab.label}
      ...
      {/* Content Area */}
      <div className="relative min-h-[400px] w-full rounded-3xl border border-glass-hover bg-white/[0.02] backdrop-blur-md p-6 sm:p-10 overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'roadmap' && (
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-faint font-mono">From MVP to a Global Autonomous Identity Network.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                ...
                <div className="bg-surface-deep border border-glass-hover rounded-2xl p-6 relative z-10 hover:border-electric-blue/50 transition-colors">
                  ...
                  <ul className="text-xs text-faint space-y-2 font-mono">
                ...
                <div className="bg-surface-deep border border-glass-hover rounded-2xl p-6 relative z-10 hover:border-axiom-purple/50 transition-colors transform md:-translate-y-4 shadow-xl">
                ...
                <div className="bg-surface-deep border border-glass-hover rounded-2xl p-6 relative z-10 hover:border-emerald-400/50 transition-colors">
          ...
          {activeTab === 'architecture' && (
            ...
            >
              <div className="flex-1 space-y-4">
                ...
                <div className="bg-surface-deep rounded-xl p-4 border border-glass-hover font-mono text-[10px] sm:text-xs text-subtle overflow-x-auto shadow-inner">
                  ...
                  <span className="text-faint">{"// Event Sourced Transition Pipeline"}</span><br/>
              ...
              <div className="flex-1 flex justify-center">
                <div className="relative w-64 h-64">
                   ...
                   <div className="absolute inset-4 border border-glass-hover rounded-full flex items-center justify-center bg-surface-deep/50 backdrop-blur-md">
                     <TerminalSquare className="w-12 h-12 text-faint" />
                   </div>
          ...
          {activeTab === 'capsule' && (
            ...
            >
              <div className="flex-1 flex justify-center">
                 <div className="relative w-full max-w-xs aspect-square border border-glass-hover rounded-3xl bg-gradient-to-br from-white/[0.05] to-transparent p-6 flex flex-col justify-between group hover:border-axiom-purple/50 transition-colors">
                    <div className="flex justify-between items-start">
                       <Shield className="w-8 h-8 text-axiom-purple" />
                       <div className="px-3 py-1 rounded-full bg-glass-hover text-[10px] font-mono font-bold text-white border border-white/20">.IDENTITY</div>
                    </div>
                    <div>
                       <div className="w-3/4 h-2 bg-glass-hover rounded mb-2" />
                       <div className="w-1/2 h-2 bg-glass-hover rounded mb-6" />
              ...
              <div className="flex-1 space-y-4 text-center md:text-left">
                ...
                <ul className="text-xs text-subtle font-mono space-y-3 mt-4 text-left inline-block">
                  ...
                  <li className="flex items-center gap-3"><Code2 className="w-4 h-4 text-faint" /> Embedded Base Genome</li>
                </ul>
                <p className="text-xs text-faint font-mono italic mt-4">

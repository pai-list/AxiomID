...
export default function InteractivePassportCard({ user, readonly = false, locked = false, onSign }: InteractivePassportCardProps) {
  ...
  return (
    <div
      ...
      {/* Action Buttons */}
      {!locked && !readonly && (
        <div className="flex items-center justify-center gap-2 mt-4 absolute -bottom-12 left-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button

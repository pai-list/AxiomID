...
export const diagnostics = defineDiagnostics({
  ...
  codes: {
    ...
    AXIOMID_E001: {
      ...
      fix: `Check the request body format and ensure all required fields are provided.`,
    },
    AXIOMID_E002: {
    ...
    AXIOMID_E013: {
      ...
      fix: `Wait for the duration in the Retry-After / X-RateLimit-Reset header before retrying. Reduce request frequency.`,
    },

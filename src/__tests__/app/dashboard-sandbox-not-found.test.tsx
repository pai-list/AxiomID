/**
 * Tests for src/app/dashboard/sandbox/not-found.tsx
 *
 * PR change: new route-level 404 page for /dashboard/sandbox. Uses
...
import SandboxNotFound from "@/app/dashboard/sandbox/not-found";

describe("dashboard/sandbox/not-found.tsx — SandboxNotFound page", () => {
  it("renders the 'Page Not Found' heading", () => {
    render(<SandboxNotFound />);

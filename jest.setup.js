...
jest.mock("framer-motion", () => {
  ...
  return {
    motion: new Proxy({}, {
      get: (_target, prop) => {
        const Component = React.forwardRef(({ children, _whileHover, _whileTap, _initial, _animate, _exit, _transition, _viewport, _whileInView, _variants, _custom, ...props }, ref) => (

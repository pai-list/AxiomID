...
jest.mock("framer-motion", () => {
  ...
  return {
    motion: new Proxy({}, {
      get: (_target, prop) => {
        const Component = React.forwardRef(({ children, whileHover: _whileHover, whileTap: _whileTap, initial: _initial, animate: _animate, exit: _exit, transition: _transition, viewport: _viewport, variants: _variants, custom: _custom, layout: _layout, ...props }, ref) => (
    ...
    useLanguage: jest.fn(() => ({
      ...
      t: (key) => {
        const mockDict = {
          ...
          connected: "CONNECTED",
          stamp_label_connect_wallet: "Wallet Connection",
          stamp_label_complete_kyc: "KYC Verification",
          stamp_label_pi_payment: "Pi Payment",
          stamp_label_security_circle: "Security Circle",
          stamp_label_lockup_commitment: "Lockup Commitment",
          stamp_label_node_operation: "Node Operation",
          stamp_label_mainnet_migration: "Mainnet Migration",
          stamp_label_wallet_age: "Wallet Activity",
          stamp_label_mining_streak: "Mining Streak",
          stamp_label_validator_service: "Validator Service",
          settings_copy: "COPY",

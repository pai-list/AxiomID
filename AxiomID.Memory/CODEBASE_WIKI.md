...
2. **المحافظة على التسمية السيادية**: تم تحويل النظام بالكامل من الاسم القديم (AxiomID) إلى الاسم الجديد (**AxiomID**). أي كود برمجي جديد تكتبه يجب أن يتجنب استخدام الكلمة القديمة تماماً في المتغيرات ومسارات الحفظ إلا في حالات التوافق التراجعي لملفات الإعدادات القديمة مثل `.axiomid`.
